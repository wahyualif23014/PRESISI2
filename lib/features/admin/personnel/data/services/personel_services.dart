...
//     }
//   }
//   // --- FETCH MASTER DATA JABATAN (Untuk Dropdown) ---
...
//       if (response.statusCode == 200) {
//         final Map<String, dynamic> jsonResponse = jsonDecode(response.body);
//         return jsonResponse['data']; // Mengembalikan list mentah untuk diproses provider
//       }
...
//   // --- FETCH MASTER DATA TINGKAT/UNIT (Untuk Dropdown) ---
