...
class KabupatenExpansionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ExpansionTile(
        initiallyExpanded: true, // <--- INI YANG BIKIN OTOMATIS TERBUKA
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildName(data.policeName.isNotEmpty ? data.policeName : "-"),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildIconButton(Icons.edit_rounded, Colors.blue, onEdit),
                      _buildVerticalDivider(),
                      _buildIconButton(
