...
import 'package:KETAHANANPANGAN/features/operator/dashboard/data/repo/ringkasan_area_repository.dart';
import '../data/repo/distribution_repository.dart';
import '../data/repo/resapan_repository.dart';
import 'package:KETAHANANPANGAN/features/admin/dashboard/data/model/resapan_model.dart' as AdminResapanModel;
...
class _OperatorDashboardPageState extends State<OperatorDashboardPage> {
  ...
  final AdminResapanModel.ResapanModel resapanData = ResapanRepository().getResapanData() as AdminResapanModel.ResapanModel;
